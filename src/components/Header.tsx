...
const Header = () => {
  ...
  return (
    <header className="bg-[current] text-white py-5 flex justify-between items-center px-10 relative z-10">
      <h1 className="text-2xl font-bold">M&M Clothing</h1>
      ...
      <nav className="hidden md:flex gap-10 text-white font-bold">
        ...
        <Link href="/clothes" onClick={closeMenu} className='hover:text-[#8daac7]'>Clothes</Link>
